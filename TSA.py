...
st.title("Sentiment Analysis of Tweets from twitter data")
...
if not st.sidebar.checkbox("Close", True, key="a"):
...
if not st.sidebar.checkbox("Close", True, key="b"):
...
if not st.sidebar.checkbox("Close", True, key="c"):
